...
namespace MokoIndustry.Machine
{
    ...
    public partial struct MachineTickJob : IJobEntity
    {
        ...
        private bool TryProduce(ref FixedList64Bytes<byte> buf, in FixedList32Bytes<RecipeItem> req)
        {
            // requirement check
        ...
        private bool TryConsume(ref FixedList64Bytes<byte> buf, in FixedList32Bytes<RecipeItem> outs)
        {
            // is there some space?
            int total = 0;
